...
def main():
    ...
    if environment_key:
        ...
        st.sidebar.caption("Optional: set GEMINI_API_KEY as an environment variable.")
    ...
    input_key = st.sidebar.text_input(
        ...
        help="Keys are never saved to a file. Set GEMINI_API_KEY for persistent local development access.",
    )
    if input_key:
